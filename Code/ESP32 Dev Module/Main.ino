...
#define DIR1 21  // Replace with the GPIO pin for the right motor direction
#define DIR2 18 // Replace with the GPIO pin for the left motor direction
#define PW1 19  // Replace with the GPIO pin for the right motor speed
#define PW2 5  // Replace with the GPIO pin for the left motor speed
